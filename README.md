...
A sustainable digital platform designed to reduce illegal dumping and promote smarter waste disposal.

🧩 Overview

ZeroDump is an innovative web platform that aims to make waste management simpler, smarter, and more community-driven.
It allows users to report illegal waste dumping, locate the nearest waste bins, and raise awareness about proper disposal methods — all through a single platform.

The system integrates Google Gemini AI for enhanced response and guidance, and Firebase for data storage and backend management.
